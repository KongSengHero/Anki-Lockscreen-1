        ...
        when (type) { 
            "dark_blur" -> { 
                paint.shader = LinearGradient( 
                    ...
                    height.toFloat(), 
                    intArrayOf( 
                        android.graphics.Color.parseColor("#1A1F2C"), 
            ...
            "sunset" -> { 
                paint.shader = LinearGradient( 
                    ...
                    height.toFloat(), 
                    intArrayOf( 
                        android.graphics.Color.parseColor("#3B1D54"), 
                        android.graphics.Color.parseColor("#2C1635"), 
                        android.graphics.Color.parseColor("#150D24")
                    ), 
                    floatArrayOf(0f, 0.5f, 1f), 
                    Shader.TileMode.CLAMP
                )
