...
object ShinobiColors {
    val ShinobiBlue get() = SlateBlue 
    val ShinobiBlueLip get() = SlateBlueLip 
    val ShinobiRed = Color(0xFFCE0026) 
    val ShinobiRedLip = Color(0xFF99001C) 
    val ShinobiGreen get() = MatchaSage 
    val ShinobiGreenLip get() = MatchaSageLip 
    val ShinobiGreenSurface get() = MatchaSageContainer 
    val ShinobiAmber get() = WarmOchre 
    val ShinobiAmberLip get() = WarmOchreLip 
    val ShinobiAmberSurface get() = WarmOchreContainer 
...
fun getUnderlineColor(index: Int): Color = if (index % 2 == 0) ShinobiColors.UnderlineOrange else ShinobiColors.UnderlineBlue 
