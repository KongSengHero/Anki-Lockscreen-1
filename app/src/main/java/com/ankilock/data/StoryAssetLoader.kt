...
object StoryAssetLoader { 
    ...
    private var cachedStories: List<ShinobiStoryModel>? = null
    ...
    fun loadAllStories(context: Context): List<ShinobiStoryModel> { 
    ...
    fun loadStoriesForCategory(context: Context, category: String): List<ShinobiStoryModel> { 
    ...
    fun loadCoverImage(context: Context, story: ShinobiStoryModel): ImageBitmap? { 
    ...
    private fun parseStoryModelFromJson(json: JSONObject, section: String): ShinobiStoryModel { 
