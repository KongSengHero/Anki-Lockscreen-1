        ...
        Card( 
            ...
            Column( 
                ...
                OutlinedTextField( 
                    ...
                    placeholder = { Text("Paste Fish Audio API key", color = BlossomColors.TextMuted) }, 
                    singleLine = true, 
                ...
                Row( 
                    ...
                    TextButton( 
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) { 
                            Text("Get Free API Key", fontSize = 12.sp, color = BlossomColors.SakuraRose, maxLines = 1, softWrap = false) 
                        ...
                        Surface( 
                            ...
                            Column( 
                                ...
                                Text( 
                                    ...
                                    fontSize = 10.sp, 
                                    color = if (isSelected) BlossomColors.SakuraRose.copy(alpha = 0.8f) else BlossomColors.TextMuted, 
                                    maxLines = 1 
                                ) 
                            } 
                        } 
                ...
                OutlinedTextField( 
                    ...
                    placeholder = { Text(PreferencesManager.DEFAULT_FISH_AUDIO_VOICE_ID, color = BlossomColors.TextMuted) }, 
                    singleLine = true, 
                    colors = OutlinedTextFieldDefaults.colors( 
                        focusedTextColor = BlossomColors.TextPrimary, 
                        unfocusedTextColor = BlossomColors.TextPrimary, 
                ...
                Row( 
                    ...
                    TextButton( 
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) { 
                            Text("View Online", fontSize = 12.sp, color = BlossomColors.WisteriaViolet, maxLines = 1, softWrap = false) 
                            Spacer(modifier = Modifier.width(4.dp)) 
                            Icon(Icons.AutoMirrored.Filled.OpenInNew, contentDescription = null, tint = BlossomColors.WisteriaViolet, modifier = Modifier.size(13.dp)) 
                        } 
                    } 
                    ...
                    TextButton( 
                        ...
                        Text("Reset Default", fontSize = 12.sp, color = BlossomColors.TextSecondary, maxLines = 1, softWrap = false) 
                    } 
                } 
                ...
                OutlinedButton( 
                    ...
                    if (isFetchingVoice) { 
                        ...
                        Text("Verifying with Fish Audio...", fontSize = 12.sp, color = BlossomColors.TextSecondary) 
                    } else { 
                        Icon( 
                        ...
                        Text("Fetch & Verify Voice", fontSize = 12.sp, color = BlossomColors.TextPrimary) 
                    } 
                } 
                ...
                if (fetchStatusMessage != null) { 
                    Surface( 
                        ...
                        color = if (fetchStatusIsError) BlossomColors.BlossomRed.copy(alpha = 0.12f) else BlossomColors.SakuraRoseContainer, 
                        border = BorderStroke( 
                            1.dp, 
                            if (fetchStatusIsError) BlossomColors.BlossomRed.copy(alpha = 0.4f) else BlossomColors.SakuraRose.copy(alpha = 0.4f) 
                        ), 
                        modifier = Modifier.fillMaxWidth() 
                    ) { 
                        Row( 
                            ...
                            Icon( 
                                ...
                                contentDescription = null, 
                                tint = if (fetchStatusIsError) BlossomColors.BlossomRed else BlossomColors.SakuraRose, 
                                modifier = Modifier.size(16.dp) 
                            ) 
                            Spacer(modifier = Modifier.width(8.dp)) 
                            Text( 
                                ...
                                fontSize = 12.sp, 
                                color = if (fetchStatusIsError) BlossomColors.BlossomRed else BlossomColors.SakuraRose, 
