package com.ankilock.jisho

import com.ankilock.data.JishoJapanese
import com.ankilock.data.JishoLink
import com.ankilock.data.JishoSense
    ...
    suspend fun searchWords(query: String): Result<List<JishoWord>> = withContext(Dispatchers.IO) { 
        ...
        try { 
            ...
            val request = Request.Builder() 
                .url(url) 
                .header("User-Agent", "Blossom-Android/1.0 (Japanese Learning App; contact: blossom-app@github.com)") 
                .get() 
                .build() 
