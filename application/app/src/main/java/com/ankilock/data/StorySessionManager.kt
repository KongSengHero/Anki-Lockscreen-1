...
object StorySessionManager { 
    ...
    var selectedStoryForDetails by mutableStateOf<BlossomStoryModel?>(null) 
    ...
    fun getCategoryStories(context: Context, category: String): List<BlossomStoryModel> { 
    ...
    fun getRawCuratedStories(): List<BlossomStoryModel> { 
        val list = mutableListOf<BlossomStoryModel>() 
    ...
    fun getCuratedStories(levelId: String = "starter", completedIds: Set<String> = completedStoryIds): List<BlossomStoryModel> { 
